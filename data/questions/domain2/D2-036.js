...
window.DOMAIN2_QUESTIONS.push({
  ...
  "type": "single",
  "difficulty": "hard",
  "question": "メディア企業がコンテンツ制作支援のための生成 AI プラットフォームを構築しています。ユーザーのリクエスト内容に応じて、長文の記事作成には高品質な大規模言語モデル（レイテンシー許容）、SNS 投稿や短文キャッチコピーの生成にはコスト効率の良い軽量モデル（低レイテンシー必須）を動的に選択する必要があります。さらに、各モデルのレイテンシーとコストの実績メトリクスに基づいて最適なモデルを自動選択したいと考えています。この要件を最小の運用負荷で実現するアーキテクチャはどれですか。",
  "options": [
    {
      "id": "A",
