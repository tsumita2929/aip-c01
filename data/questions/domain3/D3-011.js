...
window.DOMAIN3_QUESTIONS.push({
  ...
  "optionExplanations": {
    ...
    "D": {
      "correct": false,
      "text": "不正解です。モデル呼び出しログによる検出は不適切出力の傾向分析には有用であるものの、事後的な監視にとどまり不適切コンテンツがユーザーに表示された後の検出となるため、リアルタイムの出力安全性確保という要件を満たしません。"
    }
  },
  "references": [
    {
