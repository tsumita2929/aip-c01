...
window.DOMAIN3_QUESTIONS.push({
  ...
  "optionExplanations": {
    ...
    "C": {
      "correct": false,
      "text": "不正解です。CloudWatch Logs Insights によるログ分析は不適切パターンの傾向把握には有用であるものの、事後的な検出にとどまり不適切コンテンツのリアルタイムブロックはできないため、多層防御のレイヤーという要件を満たしません。"
    },
    "D": {
      "correct": true,
    ...
    "E": {
      "correct": false,
      "text": "不正解です。モデル呼び出しログの S3 保存はコンプライアンスの事後監査に有用であるものの、不適切コンテンツの防止（リアルタイムブロック）機能ではないため、多層防御のレイヤーという要件を満たしません。"
    }
  },
  "references": [
    {
