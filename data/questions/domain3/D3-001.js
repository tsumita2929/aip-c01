...
window.DOMAIN3_QUESTIONS.push({
  ...
  "optionExplanations": {
    ...
    "C": {
      "correct": false,
      "text": "不正解です。システムプロンプトによる安全性制御は追加コストなく設定できるものの、プロンプトインジェクション攻撃で回避される可能性があり、確実なコンテンツフィルタリングの保証がなく、カテゴリ別の厳密度設定という要件を満たしません。"
    },
    "D": {
      "correct": false,
