...
window.DOMAIN3_QUESTIONS.push({
  ...
  "optionExplanations": {
    "A": {
      "correct": false,
      "text": "不正解です。SCP はアカウントレベルの制御で全ユーザーに適用されるものの、チーム別の異なるモデル許可設定ができず、開発チーム固有のモデル制限という要件を満たしません。"
    },
    "B": {
      "correct": true,
    ...
    "C": {
      "correct": false,
      "text": "不正解です。モデルアクセスリクエスト管理はアカウント内の全ユーザーに同じ制限が適用されるものの、チーム別の制御ができず、開発チーム固有の制御という要件を満たしません。"
    },
    "D": {
      "correct": false,
      "text": "不正解です。CloudTrail + Lambda は事後的な検出・対応であるものの、未承認モデルの呼び出し自体を防止できず、権限の自動取り消しは正当なアクセスにも影響する可能性があり、アクセス制御という要件を満たしません。"
    }
  },
  "references": [
    {
